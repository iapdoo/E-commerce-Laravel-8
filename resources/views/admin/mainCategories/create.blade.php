                                                ...
                                                @if(get_language()->count()>0)
                                                    @foreach(get_language() as $index=> $lang )
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> اسم القسم - {{trans('admin.'.$lang->abbr) }} </label>
                                                            ...
                                                            <div class="col-md-6 hidden">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> أختصار اللغة -{{trans('admin.'.$lang->abbr) }} </label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mt-1">
                                                                    ...
                                                                    <label for="switcheryColor4"
                                                                           class="card-title ml-1">الحالة -{{trans('admin.'.$lang->abbr) }}  </label>
